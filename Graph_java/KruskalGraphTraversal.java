...
public class KruskalGraphTraversal {
    ...
    public String find(String node) {   // Jika sebuah node tidak memiliki representasi, ia mewakili dirinya sendiri.
        ...
        // Path Compression: Meningkatkan efisiensi dengan menghubungkan node langsung
        // ke representasi setnya.
    ...
    public void kruskalMST() {
        ...
        for (Edge edge : edges) {
            ...
            // Jika dua node tidak berada dalam set yang sama, tambahkan sisi ke MST dan
            // gabungkan setnya.
